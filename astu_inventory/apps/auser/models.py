...
class User(AbstractUser, Address):
    ...
    class Meta:
        ...
        permissions = [
            ...
            ("can_list_all_staff_members", "Can list all staff member"),
            ("can_list_all_store_officers", "Can list all store officer"),
            ("can_list_all_lab_assistant", "Can list all lab assistant"),
        ]
