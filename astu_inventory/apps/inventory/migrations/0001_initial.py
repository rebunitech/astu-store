    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('ACTIVE', 'Active'), ('INACTIVE', 'Inactive')], default='ACTIVE', help_text='Is the lab on work?', max_length=8, verbose_name='status')),
                ('remark', models.TextField(blank=True, max_length=255, verbose_name='remark')),
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='labs', to='auser.department', verbose_name='department')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('table_id', models.CharField(default=astu_inventory.apps.inventory.models.get_ID, max_length=50, unique=True, verbose_name='table ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remark', models.TextField(blank=True, max_length=255, verbose_name='remark')),
                ('department', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='stores', to='auser.department', verbose_name='department')),
                ('store_officers', models.ManyToManyField(related_name='store_offcers', to=settings.AUTH_USER_MODEL, verbose_name='store officers')),
            ],
            options={
                'verbose_name': 'store',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('shelf_id', models.CharField(default=astu_inventory.apps.inventory.models.get_ID, max_length=50, unique=True, verbose_name='shelf ID')),
                ...
                ('status', models.CharField(choices=[('ACTIVE', 'Active'), ('INACTIVE', 'Inactive')], default='ACTIVE', max_length=8, verbose_name='status')),
                ('remark', models.TextField(blank=True, max_length=255, verbose_name='remark')),
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shelves', to='inventory.store', verbose_name='store')),
            ],
            options={
                'verbose_name': 'shelf',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', smart_selects.db_fields.ChainedForeignKey(auto_choose=True, chained_field='college', chained_model_field='college', on_delete=django.db.models.deletion.PROTECT, related_name='products', to='auser.department', verbose_name='department')),
                ...
                ('sub_category', smart_selects.db_fields.ChainedForeignKey(auto_choose=True, chained_field='category', chained_model_field='category', on_delete=django.db.models.deletion.PROTECT, related_name='products', to='inventory.subcategory', verbose_name='sub category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shelf', smart_selects.db_fields.ChainedForeignKey(auto_choose=True, blank=True, chained_field='store', chained_model_field='store', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='shelves', to='inventory.shelf', verbose_name='shelf')),
                ('store', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='stores', to='inventory.store', verbose_name='store')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, help_text='Product eg. Hp,Dell,Toshiba, if you have one.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='specifications_product', to='inventory.product', verbose_name='product')),
                ('specification_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='specifications_types', to='inventory.specificationtype', verbose_name='specification type')),
            ],
            options={
