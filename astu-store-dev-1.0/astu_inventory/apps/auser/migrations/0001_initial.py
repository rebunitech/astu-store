    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_name', models.CharField(help_text='Abbreviated name of the department. eg CSE, ECE, EPCE', max_length=10, unique=True, validators=[astu_inventory.apps.auser.validators.ShortNameValidator()], verbose_name='short name')),
            ...
            options={
                ...
                'db_table': 'department',
                'permissions': [('can_list_departments', 'Can list departments'), ('can_activate_department', 'Can activate department'), ('can_deactivate_department', 'Can deactivate department'), ('can_list_department_heads', 'Can list department heads')],
            },
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('email', models.EmailField(help_text='Active email address. Use organizational email (@astu.edu.et) if you have.', max_length=254, unique=True, verbose_name='email address')),
