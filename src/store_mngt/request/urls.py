...
from .import views
from .views import ( AddItemView, AddRequestView, BorrowDetailView, DeleteRequestView, ItemUpdateView,
                     RequestDetailView, ListItemView, RequestListView,RequestHistoryView
                    )
app_name = "request"
urlpatterns = [
    ...
    path("view_history/<int:pk>", RequestHistoryView.as_view(), name="request_history"),
