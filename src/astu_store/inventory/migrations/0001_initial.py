...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('table_id', models.CharField(default=inventory.models.get_ID, max_length=50, unique=True, verbose_name='table ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('shelf_id', models.CharField(default=inventory.models.get_ID, max_length=50, unique=True, verbose_name='shelf ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('college', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='auser.college', verbose_name='college')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='items', to='inventory.store', verbose_name='store')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remark', models.TextField(blank=True, max_length=255, verbose_name='remark')),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='specifications', to='inventory.item', verbose_name='item')),
